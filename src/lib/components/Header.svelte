    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block ml-7">
      <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
        ...
        <div class="flex items-center gap-x-4 sm:ms-auto">
          ...
          <a class="flex items-center font-medium text-gray-900 hover:text-blue-600 dark:text-gray-200 dark:hover:text-blue-500" href="https://discord.gg/HhVet3FU2h" target="_blank">
          ...
          <a class="flex items-center font-medium text-gray-900 hover:text-blue-600 dark:text-gray-200 dark:hover:text-blue-500" href="https://github.com/mediakular/gridcraft" target="_blank">
