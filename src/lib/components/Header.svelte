  ...
  <nav class="relative {!isDocs ? 'max-w-[85rem]' : ''} w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block ml-7">
      <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
        ...
        <div class="flex items-center gap-x-4 sm:ms-auto">
          ...
          <a class="flex items-center text-gray-900 hover:text-blue-600 dark:text-gray-200 dark:hover:text-blue-500" href="https://discord.gg/HhVet3FU2h" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 50 50" fill="currentColor" stroke="currentColor" stroke-width="1">
          ...
          <a class="flex items-center" href="https://twitter.com/grid_craft" target="_blank">
            <svg  width="22" height="22" viewBox="0 0 2134 1925" class="fill-gray-900 hover:fill-blue-600 dark:fill-gray-200 dark:hover:fill-blue-500" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M1680.12,0l327.108,0l-714.65,816.833l840.754,1111.5l-658.325,0l-515.587,-674.133l-589.967,674.133l-327.333,0l764.396,-873.679l-806.517,-1054.65l674.996,0l466.067,616.167l539.058,-616.167Zm-114.817,1732.52l181.271,-0l-1170.06,-1546.99l-194.499,0l1183.29,1546.99Z" style="fill-rule:nonzero;"/></svg>
          </a>
          <a class="flex items-center text-gray-900 hover:text-blue-600 dark:text-gray-200 dark:hover:text-blue-500" href="https://github.com/mediakular/gridcraft" target="_blank">
