...
<button type="button" class="hs-dark-mode-active:hidden flex hs-dark-mode group items-center text-gray-600 hover:text-blue-600 font-medium dark:text-gray-200 dark:hover:text-gray-500" data-hs-theme-click-value="dark" aria-label="Dark Mode">
...
<button type="button" class="hs-dark-mode-active:flex hidden hs-dark-mode group items-center text-gray-600 hover:text-blue-600 font-medium dark:text-gray-200 dark:hover:text-gray-500" data-hs-theme-click-value="light" aria-label="Light Mode">
