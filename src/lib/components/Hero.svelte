...
<div
	class="relative z-50 overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('/bg.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-[1] before:transform before:-translate-x-1/2 dark:before:bg-[url('/bg.svg')] dark:before:opacity-[3%]"
>
       ...
       End Announcement Banner -->
		...
		<div class="mt-5 max-w-2xl text-center mx-auto">
			<h1 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
				GridCraft:
				<span
					class="block bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"
					>Empower Your Data</span
				>
			</h1>
		</div>
		<!-- End Title -->
		...
		<div class="mt-5 max-w-3xl text-center mx-auto">
			<p class="text-lg text-gray-600 dark:text-gray-400">
				Unleash the power of your data with GridCraft – a versatile headless component for seamless
				data visualization and customization. Transform your SvelteKit apps with ease!
			</p>
		</div>
		...
		<div class="mt-8 gap-3 flex justify-center">
			...
			<div class="relative">
				...
				<span
					class:opacity-0={!showCopied}
					class:opacity-full={showCopied}
					class="absolute transition-all right-[-70px] text-gray-400 top-3">Copied!</span
				>
			</div>
		</div>
		<!-- End Buttons -->
		...
		<div class="mt-5 flex justify-center items-center gap-x-1 sm:gap-x-3">
			...
			<svg
				class="size-5 text-gray-300 dark:text-gray-600"
				width="16"
				height="16"
				viewBox="0 0 16 16"
				fill="none"
