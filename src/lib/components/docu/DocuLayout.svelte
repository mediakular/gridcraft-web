...
<article class="bg-gray-50 dark:bg-slate-900">
    <!-- ========== MAIN CONTENT ========== -->
    <!-- Sidebar Toggle -->
    ...
    <!-- Content -->
    <div class="flex flex-col-reverse md:flex-row w-full relative">
        <div class="md:w-3/4 lg:w-2/3  px-4 mt-24 sm:px-6 md:px-8 lg:ps-72 pb-10">
        ...
        <aside class="mt-24 max-h-screen sticky md:top-[120px] lg:top-[75px] md:w-1/4 lg:w-1/3">
            <figure class="pr-10 w-full ">
                <div id="toc" class="prose pt-3"><span class="text-sm text-gray-600 font-bold ml-6">In this article</span></div>
            </figure>
        </aside>
    </div>
    <!-- End Content -->
